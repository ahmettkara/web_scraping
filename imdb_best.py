...
from ..items import ImdblistItem


class ImdbSpider(scrapy.Spider):
    name ='imdb'
    start_urls = ["https://www.imdb.com/list/ls004610270/?st_dt=&mode=detail&page=1&sort=list_order,asc&ref_=ttls_vm_"
                  "dtlhttps://www.imdb.com/list/ls004610270/?st_dt=&mode=detail&page=1&sort=list_order,asc&ref_=ttls_vm_dtl"]
